...
async def get_all_users(
    ...
    user_service_admin: UserServiceAdmin = Depends(get_user_service_admin)
):
    """
    ...
    try:
        ...
        result = await user_service_admin.get_all_users_paginated(
            db=db,
            page=page,
            limit=limit,
            search=search,
...
async def search_users(
    ...
    try:
        ...
        result = await user_service_admin.search_users_advanced(
            db=db,
            filters=filter_dict,
            page=page,
            limit=limit
...
async def get_user_by_id(
    ...
    try:
        ...
        user = await user_service_admin.get_user_by_id_admin(user_id, db)
...
async def create_user(
    ...
    try:
        ...
        # Create user
        new_user = await user_service_admin.create_user_admin(
            user_data.dict(),
...
async def update_user(
    ...
    try:
        ...
        updated_user = await user_service_admin.update_user_admin(
            user_id=user_id,
...
async def update_user_status(
    ...
    try:
        ...
        # Update user status
        updated_user = await user_service_admin.update_user_status_admin(
            user_id=user_id,
...
async def bulk_user_action(
    ...
    try:
        ...
        # Perform bulk action
        result = await user_service_admin.bulk_user_action_admin(
...
async def get_user_statistics(
    ...
    try:
        ...
        stats = await user_service_admin.get_user_statistics_admin(db)
